...
def get_args():
    ...
    parser.add_argument('-p', '--path', default='../../datasets/cocktail_party',
...
def build_X(people_lines, max_people, d, convert_units=False):
    ...
    for i in range(num_examples):
        ...
        while j < len(split):
            ...
            if convert_units:
                # "cocktail" not in args.path and "SALSA" not in args.path and "FM" not in args.path:
...
if __name__ == "__main__":
    ...
    for k in range(num_folds):
        ...
        timestamps_test, timestamps_train, timestamps_val = split_test_train_val(start_test, end_test, val_start_ends,
                                                                                 timestamps)
