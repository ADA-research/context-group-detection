...
def generate_dataset(num_sims, length, sample_freq):
    ...
    for i in range(num_sims):
        ...
        loc_sampled, vel_sampled, loc, vel, edges_sampled, edges, ga, gr, sampled_indices = sim.sample_trajectory(
            T=length,
...
loc_sampled_all_sim, vel_sampled_all_sim, loc_all_sim, vel_all_sim, edges_all_sampled_sim, edges_all_sim, ga_sim, gr_sim, sampled_indices_all_sim = generate_dataset(
    args.num_sim,
    args.length,
    args.sample_freq)
